...
const cekafk = (_dir) => {
    setInterval(() => {
		...
		const ovo = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/arietube.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const dana = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/arietube.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const gopay = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/arietube.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "© Arie Tube", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "© Arie Tube", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const sendreply = (from, teks, faketeks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./media/image/arietube.jpg'), surface: 200, message: `Arie tube`, orderTitle: `Arie Tube`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
	...
	//•======>> SUBSCRIBE : ARIE TUBE <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6288245009287?text=Assalamualaikum%20Bang%20Arietube}}})
		}
		const simir = (teks) => {
...
pemuda.sendMessage(from, img, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
case 'tahta': 
...
pemuda.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
case 'nuliskanan':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
case 'maker2d2': 
					...
					pemuda.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
					break
		case 'maker2d3': 
...
if (!isQuotedSticker) return reply(`Reply Stikernya`)
	...
	pempa = anee[0] !== "" ? anee[0] : `It's Me Arietube`;
...
break
case 'bugtrolites':
 const pemuda6 = fs.readFileSync(`./media/image/arietube.jpg`)
pemuda.sendMessage(from, {quoted: ftrol, thumbnail: fs.readFileSync('./media/virgam.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/egNE_fgjEMU`}}})
break
//•======>> SUBSCRIBE : ARIE TUBE <<====•\\
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
pemuda.sendMessage(from, goo, image, {quoted: fvid, caption: 'Nih Jangan Lupa Subscribe Arie Tube'})
break
case 'cecanrandom':
...
pemuda.sendMessage(from, kon, video, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
...
pemuda.sendMessage(from, kon, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
pemuda.sendMessage(from, hai, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
pemuda.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/arietube.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('6288245009287@s.whatsapp.net', options, text, {quoted: mek})
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Instagram Pemilik Bot, Jangan Lupa Follow yak😉\n\nhttps://instagram.com/Arie tube", matchedText: 'https://instagram.com/Arie tube', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
...
case 'partnerbot':
		pemuda.sendMessage(from, { text: "*Partner BOT Nabila*\n\n- Bot Arietube :\nhttps://wa.me/6288245009287?text=hay%20bang\nThanks Udah Makek Bot ini😉", matchedText: 'https://youtu.be/egNE_fgjEMU', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'speed':
               case 'ping':
